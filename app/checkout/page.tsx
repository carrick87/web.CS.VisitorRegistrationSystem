    ...
    <main className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 py-8">
      <div className="container mx-auto px-4 max-w-lg">
        ...
        <div className="card text-center py-12">
          ...
          <h1 className="text-2xl font-bold text-gray-800 mb-4">Check-Out Has Changed</h1>

          <p className="text-gray-600 mb-6 max-w-sm mx-auto">
            Self-service check-out is no longer available. Please{' '}
            <strong>return your visitor tag</strong> to the storekeeper when you leave.
          </p>
